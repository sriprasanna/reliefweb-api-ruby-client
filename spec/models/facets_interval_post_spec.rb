...
# Unit tests for SwaggerClient::FacetsIntervalPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FacetsIntervalPost' do
  before do
    # run before each test
    @instance = SwaggerClient::FacetsIntervalPost.new
  end
  ...
  describe 'test an instance of FacetsIntervalPost' do
    it 'should create an instance of FacetsIntervalPost' do
      expect(@instance).to be_instance_of(SwaggerClient::FacetsIntervalPost)
    end
  end
end
