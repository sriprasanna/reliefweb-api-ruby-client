...
# Unit tests for SwaggerClient::FilterNegatePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FilterNegatePost' do
  before do
    # run before each test
    @instance = SwaggerClient::FilterNegatePost.new
  end
  ...
  describe 'test an instance of FilterNegatePost' do
    it 'should create an instance of FilterNegatePost' do
      expect(@instance).to be_instance_of(SwaggerClient::FilterNegatePost)
    end
  end
end
