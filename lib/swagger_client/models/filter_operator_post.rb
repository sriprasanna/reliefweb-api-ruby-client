...
module SwaggerClient
  class FilterOperatorPost
    ...
    def build_from_hash(value)
      constantValues = FilterOperatorPost.constants.select { |c| FilterOperatorPost::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #FilterOperatorPost" if constantValues.empty?
      value
    end
  end
end
