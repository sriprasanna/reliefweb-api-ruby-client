...
# Unit tests for SwaggerClient::FieldsExcludePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FieldsExcludePost' do
  before do
    # run before each test
    @instance = SwaggerClient::FieldsExcludePost.new
  end
  ...
  describe 'test an instance of FieldsExcludePost' do
    it 'should create an instance of FieldsExcludePost' do
      expect(@instance).to be_instance_of(SwaggerClient::FieldsExcludePost)
    end
  end
end
