...
# Unit tests for SwaggerClient::QueryOperatorPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueryOperatorPost' do
  before do
    # run before each test
    @instance = SwaggerClient::QueryOperatorPost.new
  end
  ...
  describe 'test an instance of QueryOperatorPost' do
    it 'should create an instance of QueryOperatorPost' do
      expect(@instance).to be_instance_of(SwaggerClient::QueryOperatorPost)
    end
  end
end
