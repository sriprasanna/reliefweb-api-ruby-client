...
module SwaggerClient
  class Training
    ...
    def hash
      [category, city, country, date, description, description_html, file, format, how_to_apply_html, how_to_apply, id, language, link, theme, title, url].hash
    end
