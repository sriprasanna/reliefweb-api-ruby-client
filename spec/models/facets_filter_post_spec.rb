...
# Unit tests for SwaggerClient::FacetsFilterPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FacetsFilterPost' do
  before do
    # run before each test
    @instance = SwaggerClient::FacetsFilterPost.new
  end
  ...
  describe 'test an instance of FacetsFilterPost' do
    it 'should create an instance of FacetsFilterPost' do
      expect(@instance).to be_instance_of(SwaggerClient::FacetsFilterPost)
    end
  end
end
