...
# Unit tests for SwaggerClient::FilterConditionsPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FilterConditionsPost' do
  before do
    # run before each test
    @instance = SwaggerClient::FilterConditionsPost.new
  end
  ...
  describe 'test an instance of FilterConditionsPost' do
    it 'should create an instance of FilterConditionsPost' do
      expect(@instance).to be_instance_of(SwaggerClient::FilterConditionsPost)
    end
  end
end
