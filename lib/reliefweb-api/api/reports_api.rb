...
module ReliefWebAPI
  class ReportsApi
    ...
    # @return [Report]
    def get_report_by_id(report_id, opts = {})
      data, _status_code, _headers = get_report_by_id_with_http_info(report_id, opts)
      data
    end
    ...
    def get_report_by_id_with_http_info(report_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReportsApi.get_report_by_id ...'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Report')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReportsApi#get_report_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_reports_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling ReportsApi.get_reports, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling ReportsApi.get_reports, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling ReportsApi.get_reports, must be greater than or equal to 0.'
      end
    ...
    # @return [Report]
    def search_reports(opts = {})
      data, _status_code, _headers = search_reports_with_http_info(opts)
      data
    end
    ...
    # @option opts [PostParams] :fields Returned fields
    # @return [Array<(Report, Fixnum, Hash)>] Report data, response status code and response headers
    def search_reports_with_http_info(opts = {})
      if @api_client.config.debugging
