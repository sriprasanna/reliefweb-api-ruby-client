...
# Unit tests for SwaggerClient::FieldsIncludePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FieldsIncludePost' do
  before do
    # run before each test
    @instance = SwaggerClient::FieldsIncludePost.new
  end
  ...
  describe 'test an instance of FieldsIncludePost' do
    it 'should create an instance of FieldsIncludePost' do
      expect(@instance).to be_instance_of(SwaggerClient::FieldsIncludePost)
    end
  end
end
