...
# Unit tests for SwaggerClient::QueryValuePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueryValuePost' do
  before do
    # run before each test
    @instance = SwaggerClient::QueryValuePost.new
  end
  ...
  describe 'test an instance of QueryValuePost' do
    it 'should create an instance of QueryValuePost' do
      expect(@instance).to be_instance_of(SwaggerClient::QueryValuePost)
    end
  end
end
