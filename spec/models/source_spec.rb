...
# Unit tests for SwaggerClient::Source
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Source' do
  before do
    # run before each test
    @instance = SwaggerClient::Source.new
  end
  ...
  describe 'test an instance of Source' do
    it 'should create an instance of Source' do
      expect(@instance).to be_instance_of(SwaggerClient::Source)
    end
  end
  ...
  describe 'test attribute "longname"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
