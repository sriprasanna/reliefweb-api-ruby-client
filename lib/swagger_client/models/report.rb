...
module SwaggerClient
  class Report
    ...
    # Report production and coordination bodies.
    attr_accessor :source

    attr_accessor :status

    # Category of information contained in the report.
    attr_accessor :theme
    ...
    def hash
      [body, country, date, format, id, language, primary_country, source, status, theme, title, type].hash
    end
