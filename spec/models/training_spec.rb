...
# Unit tests for ReliefWebAPI::Training
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Training' do
  before do
    # run before each test
    @instance = ReliefWebAPI::Training.new
  end
  ...
  describe 'test an instance of Training' do
    it 'should create an instance of Training' do
      expect(@instance).to be_instance_of(ReliefWebAPI::Training)
    end
  end
