...
# Unit tests for SwaggerClient::FilterOperatorPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FilterOperatorPost' do
  before do
    # run before each test
    @instance = SwaggerClient::FilterOperatorPost.new
  end
  ...
  describe 'test an instance of FilterOperatorPost' do
    it 'should create an instance of FilterOperatorPost' do
      expect(@instance).to be_instance_of(SwaggerClient::FilterOperatorPost)
    end
  end
end
